...
//   return (
//     <MainLayout>
//       <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-[866px] h-auto md:h-[501px] bg-[#1c2b3a] rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row items-center justify-center">
//         {/* Left Section */}
...
//         {/* Right Section */}
//         <div className="w-full md:w-[390px] h-auto md:h-[481px] bg-white rounded-b-[6px] md:rounded-[6px] flex items-center h-screen flex-col justify-between p-6 md:p-8">
//           <div>
